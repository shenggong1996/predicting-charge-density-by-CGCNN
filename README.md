For the paper 'Predicting charge density distribution of materials using a local-environment-based graph convolutional network', we use the original version of CGCNN (https://github.com/txie-93/cgcnn)
